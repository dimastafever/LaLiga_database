...
## 4. Список созданных запросов с их описанием
...
## 5. Список созданных процедур, функций, представлений, триггеров
...
## 6. Рекомендации по работе с базой данных – оптимизация с помощью индексов
